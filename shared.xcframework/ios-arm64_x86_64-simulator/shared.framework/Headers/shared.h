...
*/
- (void)totoWithCompletionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("toto(completionHandler:)")));
@property (readonly) id<SharedKotlinx_coroutines_coreMutableStateFlow> totoResult __attribute__((swift_name("totoResult")));
@end
